...
* <pre>
* var SalesforceMarketingCloudSdk = require('index'); // See note below*.
* var xxxSvc = new SalesforceMarketingCloudSdk.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new SalesforceMarketingCloudSdk.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new SalesforceMarketingCloudSdk.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new SalesforceMarketingCloudSdk.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
